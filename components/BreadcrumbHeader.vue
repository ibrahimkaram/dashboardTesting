  ...
  <div>
    ...
    <div class="mt-2 md:flex md:items-center md:justify-between">
      <div class="min-w-0 flex-1">
        <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">My Launched Currencies</h2>
      </div>
...
const crumbs = [
  ...
  { name: 'TokenDetails', to: '/collaborate', current: true },
]
</script>