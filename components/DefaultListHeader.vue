...
<template>
  <div class="sm:flex sm:items-center sm:justify-between">
    <h1 class="text-lg font-medium leading-6 text-gray-900">List Items</h1>
    <div class="mt-3 sm:mt-0 sm:ml-4">
      ...
      <div class="flex rounded-md shadow-sm">
        <div class="relative flex-grow focus-within:z-10">
          ...
          <input type="text" name="desktop-search-candidate" id="desktop-search-candidate" class="hidden w-full h-full rounded-none rounded-l-md border-gray-300 pl-10 focus:border-indigo-500 focus:ring-indigo-500 sm:block sm:text-sm" placeholder="Search list" />
        </div>
